...
$link = mysqli_connect("localhost", "root", "", "shake");
        ...
        $db_selected = mysqli_select_db($link, "shake");

        if(!$db_selected)
        {
            die('Can\'t use '. 'Shake' . ' database!' .  mysql_error());
        }
				  ...
				  <div class="contact-form">
				  	<h3>Preferences</h3>
					    	<div>
                                ...
                                <span><input class="textbox" type="text" name="budget"></span>
						    </div>
						    <div>
						    	<span><label>How many people are you expecting? (*)</label></span>
						    	<span><input name="people" type="text" class="textbox"></span>
						    </div>
						    <div>
						     	<span><label>Type of Function (*)</label></span>
						    	<span><select class="form-control" type="checkbox" name="function">
						    ...
						    <div>
						    	...
						    	<span><select class="form-control" type="text" name="menu">
                                  <option>Select one</option>
                                  <option>Lunch</option>
				  ...
				  <div class="contact-form">
				  	<h3>Preferences</h3>
					    	<div>
						    	...
						    	<span><select class="form-control" type="text" name="service">
                                  <option>Select one</option>
                            ...
                            <div>
						    	<span><label>Details of venue and type of menu required (*)</label></span>
						    	<span><textarea name="detailsvenue"> </textarea></span>
						    </div>
						    <div>
						    	<span><label>Address of Venue</label></span>
						    	<span><input name="addressvenue" type="text" class="textbox"></span>
						    </div>
